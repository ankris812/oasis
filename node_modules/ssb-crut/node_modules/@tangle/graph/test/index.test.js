...
test('graph.connectedKeys', t => {
  t.deepEqual(graph.connectedKeys, ['A', 'B', 'C', 'D'], 'connectedKeys')

  t.end()
})

test('graph.connectedNodes', t => {
  t.deepEqual(graph.connectedNodes, [A, B, C, D], 'connectedNodes')
